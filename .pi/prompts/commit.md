...
6. `git commit` locally (template applies, AUTO-RUN for important changes — finished task, checkpoint, docs/policy — no ask needed; keep trivial/WIP uncommitted), then `git log --oneline -3`.
